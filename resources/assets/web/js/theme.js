/**
 * Printogram This file contains all template JS functions
 * 
 * @package Printogram -------------------------------------------------------------- Contents -------------------------------------------------------------- 01 - Product Zoom 02 - Owl Carousel 03 - Slider Text 04 - Facts Count 05 - Navigation 06 - Video Play 07 - Work Filter 08 - Product Category Filter 09 - Star Rating 10 - Preloader --------------------------------------------------------------
 */
...
// clearTimeout( hoverTimeout );
					...
					var objWidth = $( this ).children( '.dropdown-menu' ).outerWidth( true );
					if ( ( offsetLeft + objWidth ) > $( '.container' ).width() ) {
